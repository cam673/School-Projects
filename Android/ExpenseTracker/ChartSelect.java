...
//select the year the user would like to view charts from
public class ChartSelect extends AppCompatActivity
{
    private ListView chartYear;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            yearList = UserData.years.get(userID);
        }
        else
        {
        ...
        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, yearList);
        chartYear.setAdapter(arrayAdapter);

        chartYear.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Intent intent = new Intent(getApplicationContext(), ChartMonth.class);
